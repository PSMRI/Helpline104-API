...
/**
 * Set/get round trips and constructor drives for the CovidMaster entities.
 */
class CovidMasterEntityAccessorsTest {

	@Test
	void everyAccessorRoundTripsAndEveryConstructorBuilds() {
		EntityAccessors.assertEntities(
				Covid19BenFeedback.class,
				SymptomsMaster.class);
	}
}
