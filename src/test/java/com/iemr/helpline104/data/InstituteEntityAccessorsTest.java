...
/**
 * Set/get round trips and constructor drives for the Institute entities.
 */
class InstituteEntityAccessorsTest {

	@Test
	void everyAccessorRoundTripsAndEveryConstructorBuilds() {
		EntityAccessors.assertEntities(
				Institute.class,
				InstituteDirectory.class,
				InstituteSubDirectory.class,
				InstituteType.class);
	}
}
