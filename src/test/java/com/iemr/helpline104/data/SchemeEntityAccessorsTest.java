...
import com.iemr.helpline104.data.scheme.Scheme;
import com.iemr.helpline104.data.scheme.T_Schemeservice;

/**
 * Set/get round trips and constructor drives for the Scheme entities.
 */
class SchemeEntityAccessorsTest {

	@Test
	void everyAccessorRoundTripsAndEveryConstructorBuilds() {
		EntityAccessors.assertEntities(
				Scheme.class,
				T_Schemeservice.class);
	}
}
