...
/**
 * Set/get round trips and constructor drives for the BloodRequest entities.
 */
class BloodRequestEntityAccessorsTest {

	@Test
	void everyAccessorRoundTripsAndEveryConstructorBuilds() {
		EntityAccessors.assertEntities(
				BloodBank.class,
				RequestedBloodBank.class,
				T_BloodRequest.class);
	}
}
