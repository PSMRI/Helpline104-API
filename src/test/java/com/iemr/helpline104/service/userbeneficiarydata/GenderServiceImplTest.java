...
class GenderServiceImplTest {
	...
	@Test
	void getActiveGendersProjectsEveryReadableRow() {
		when(repository.findAciveGenders()).thenReturn(new LinkedHashSet<>(
				Arrays.asList(new Object[0], new Object[] { (short) 1, "Female" } )));

		assertEquals(1, service.getActiveGenders().size());
	}
}
